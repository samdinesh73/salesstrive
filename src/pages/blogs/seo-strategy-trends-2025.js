...
import BlogSearch from '/src/components/widgets/BlogSearch';
import BlogCategory from '/src/components/widgets/BlogCategory';
import BlogLatestPost from '/src/components/widgets/BlogLatestPost';
import BlogTags from '/src/components/widgets/BlogTags';
...
const BlogDetails = () => {
  ...
  const { slug } = router.query;
    const blog = BlogTwoData.find((item) => item.slug === "seo-strategy-trends-2025");
                        ...
                        <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12">
                            <div className="blog-details__left">
                                ...
                                <div className="blog-details__content">
                                    ...
                                    <h2 className="postbox__title">{blog.heading}</h2>
