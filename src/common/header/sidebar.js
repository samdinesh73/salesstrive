        ...
        <div className={`tt-offcanvas ${isActive ? "opened" : ""}`}>
            <div className="tt-offcanvas-close" onClick={() => setIsActive(false)}>
                ...
                <div className="logo-box">
                    <Link href="/" aria-label="logo image"><img src="/assets/img/logo/logo.png"
                            width="155" alt="" /></Link>
                </div>
                ...
                <div class="offset__widget offset__support">
                    <ul class="mobile-nav__contact list-unstyled">
                        <li>
                            ...
                            <a href="mailto:hello@salesstrive.com">hello@salesstrive.com</a>
                        </li>
                        <li>
                            <i class="fa fa-phone-alt"></i>
                            <a href="tel:+6668880000">+91 98765 43210</a>
                        </li>
                        <li>
                            <i class="fas fa-map-marker-alt"></i> 3/45B,Temp add,TamilNadu </li>
                    </ul>
