                            ...
                            <div className="col-xxl-12 col-xl-12 col-lg-12">
                                <div className="header__main-content-wrapper header-padding d-flex align-items-center justify-content-between p-relative">
                                    ...
                                    <div className="header__main-right">
                                        <div className="user- _login  d-none">
                                            <i className="fa-regular fa-user"></i>
                                            <Link href="/login">Login</Link>
                                        </div>
                                        <Link href="/contact" className="header-btn-1 rr-btn-style-1 d-xxl-block d-xxl-block d-lg-block d-md-block ">Get in Touch</Link>
